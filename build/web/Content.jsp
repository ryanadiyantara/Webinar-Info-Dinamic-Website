...
<body>
    ...
    <!--------------------NAV-------------------->
    <nav>
        <a href="index.jsp" target="_parent"><img class="nav-homelogo" src="aset/Home.png" height="20px" width="20px"></a>
    ...
    <div class="daftar" width="300" height="300">
        ...
        <button class="daftar-button" onclick="btnDaftarWebinar();" >Daftar Sekarang</button>
    </div>
<%}%>
    <!--------------------FOOTER-------------------->
    <footer>
